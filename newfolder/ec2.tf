...
#below are test creds to test our tools
export AWS_ACCESS_KEY_ID=AKIAIOSFODNN7EXAMAAATEST
export AWS_SECRET_ACCESS_KEY=wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMAAAKEYTEST
